--[[
Code from:
https://github.com/VADemon/Moonlib/blob/master/serialize.lua

With reference to:
https://stackoverflow.com/questions/47917716/how-to-use-recursive-function-in-lua-to-dynamically-build-a-table-without-overwr
]]--
